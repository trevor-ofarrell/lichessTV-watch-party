...
var handleUserPlugins = (function (ref) {
  ...
  var result;
  [components, utilities].find(function (data) {
    var matches = getMatches({
      className: className,
      data: data,
      sassyPseudo: sassyPseudo,
...
var parseSelector = function (selector, ref) {
  ...
  var match = matches[0];
  if (isBase) { return match; } // Fix spacing that goes missing when provided by tailwindcss
...
var getBuiltRules = function (rule, ref) {
  ...
  var selectorParsed = selectorArray.map(function (s) { return parseSelector(s, {
    isBase: isBase
